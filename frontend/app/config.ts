...
export const ORACLE_PROGRAM_ID = "3EKbZCxvUXzrZaVKYHc7BcyqrVQPpMmN3vysSxPfZ6iE";
export const MINTER_PROGRAM_ID = "CuDJpGcDkPPUyFXQrGV6x3WZGADdiVE3tcK7WA4j5vFa";
...
export const NETWORKS: Record<NetworkId, { rpc: string; label: string }> = {
  localnet: { rpc: "http://127.0.0.1:9003", label: "Localnet" },
